...
def boar_brawl(player_score, opponent_score):
    ...
    if (player_score - opponent_score) == 0:
        ...
        return 3 * abs(player_score - opponent_score)
    # END PROBLEM 2
...
def sus_points(score):
    ...
    # BEGIN PROBLEM 4
    "*** YOUR CODE HERE ***"
    determinate_sus = num_factors(score)

    if determinate_sus == 3 or determinate_sus == 4:
...
def is_always_roll(strategy, goal=GOAL):
    ...
    "*** YOUR CODE HERE ***"
    i = 0
    possible = strategy(i, 0)
    while i < goal:
        j = 0
        while j < goal:
            temp = possible
            possible = strategy(i, j)
            j = j + 1
            if temp == possible:
                continue
            else:
...
def boar_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 10
    test_value = boar_brawl(score, opponent_score)
...
def sus_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    Suss Fuss rules."""
    # BEGIN PROBLEM 11
    test_value = sus_update(0, score, opponent_score, six_sided) - score
    if test_value >= threshold:
        return 0
    else:
        return num_rolls
